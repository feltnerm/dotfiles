...
globalkeys = awful.util.table.join(globalkeys,
    awful.key({ modkey }, "F12", 
            function() 
                awful.util.spawn(env.terminal .. " -e htop") 
            end),
    awful.key({ modkey }, "F11",
        function()
            awful.util.spawn(env.terminal .. " -e slurm -i wlan0")
        end),
    awful.key({ modkey }, "F10",
        function()
            awful.util.spawn(env.terminal .. " -e wicd-curses")
        end),
    --- }}}
    --- {{{ Multimedia
   ...
   awful.key({ }, "XF86AudioMute",        
    ...
    awful.key({ modkey }, "Home",
        function()
            awful.util.spawn(env.terminal .. " -e ranger")
        end),
    awful.key({ modkey }, "b", 
        function() 
